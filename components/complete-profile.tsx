...
export function CompleteProfile() {
  ...
  const handleAvatarChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    if (file.size > MAX_AVATAR_SIZE) { setError('Profile picture must be 2 MB or smaller.'); e.target.value = ''; return; }
